...
using QuotationServiceManagement.Domain.Shared.Expections;
using QuotationServiceManagement.Domain.Shared.Models;

namespace QuotationServiceManagement.Domain.AggregatesModel.QuotationAggregate
{
    public class Quotation : Entity, IHasGcid, IAggregateRoot
    {
        ...
        public QuotationStatus QuotationStatus { get; private set; }

        public int QuotationCount { get; private set; }
        ...
        public void ChangeQuotation(DateTime quotationDateTime, DateTime endTime)
        {
            ...
            QuotationCount++;
            EndTime = endTime;
            AddDomainEvent(new QuotationChangeDomainEvent(Id));
        }

        public void FinishQuotation(int quotationId, int quatity, DateTime submitTime)
        {
            QuotationStatus = QuotationStatus.Finished;

            AddDomainEvent(new QuotationFinishDomainEvent(quotationId, quatity, submitTime));
        }
